                        ...
                        <Paper className={classes.formControl}>
                          ...
                          <FormControlLabel
                            control={
                              <FastField
                                ...
                                name={`formFields.${index}.optional`}
                              ></FastField>
                            }
                          ...
                          <FormControl required className={classes.formControl}>
                            ...
                            <FastField
                              as={Select}
                              defaultValue=""
                              name={`formFields.${index}.answerFormat`}
                              value={formField.tag}
                              align="left"
                            >
                          ...
                          <FormControl>
                            <Field
                              ...
                              error={
                                touched.formFields &&
                                touched.formFields[index] &&
                                touched.formFields[index].name &&
                                errors[index] &&
                                errors[index].name
                              }
                              ...
                              <>
                                ...
                                {formField.hasOwnProperty("valueOptions") &&
                                  formField.valueOptions.map(
                                    (child, childIndex) => (
                                      <FieldArray
                                        name={`formFields.${index}.valueOptions`}
                                      >
                                        {({ insert, remove }) => (
                                          <>
                                            <FormControl
                                  ...
                                  <FormControlLabel
                                    control={
                                      <FastField
                                        ...
                                        name={`formFields.${index}.validateByOtp`}
                                      />
                                    }
                                    className={classes.formControl}
